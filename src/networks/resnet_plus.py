...
from layers import DropBlock2d, DropPath, AvgPool2dSame, create_attn, create_classifier
...
if __name__=="__main__":
    # ecaresnet50 = ecaresnext50t_32x4d(pretrained=True,num_classes=2)
    #print(ecaresnet50)
    # net = ig_resnext101_32x48d(pretrained=True,num_classes=2)
    # net = ig_resnext101_32x8d(pretrained=True,num_classes=2)
    # net = resnext50d_32x4d(pretrained=True,num_classes=2)
    # net = ecaresnext50t_32x4d(pretrained=True,num_classes=2)
    net = ecaresnet101d(pretrained=True,num_classes=2)